...
QString darkStyleOverrides()
{
    return QStringLiteral(
        ...
        "QFrame#transferCard { background-color: #192d3b; border-color: #31566e; }\n"
        ...
        "QLabel#transferCardIcon { background-color: #143750; border-color: #2a6a9a; }\n"
        ...
        "QFrame#transferCard QProgressBar#transferProgress { background-color: #143750; border-color: #2a6a9a; }\n"
        "QFrame#transferCard QProgressBar#transferProgress::chunk { background: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #14a3b8, stop:0.6 #2dd4bf, stop:1 #78e3f2); }\n"
        "QSplitter::handle { background-color: transparent; }\n"
        "QSplitter::handle:hover { background-color: #1a4d6e; border-radius: 4px; }\n"
        "QDialog { background-color: #0f2d42; }\n"
        "SettingsDialog { background-color: #0f2d42; }\n"
        "QWidget#aboutPanel { background-color: #0f2d42; }\n"
        "QFrame#aboutHeroCard { background-color: #143750; border-color: #2a6a9a; }\n"
        "QLabel#aboutAppIcon { background-color: #193343; border-color: #2a6a9a; }\n"
        "QLabel#aboutAppName { color: #c7def4; }\n"
        "QLabel#aboutVersionBadge { background-color: #193343; color: #78e3f2; border-color: #2a6a9a; }\n"
        "QLabel#aboutDescription { color: #d7e4ef; }\n"
        "QLabel#aboutBodyText { color: #a8bac8; }\n"
        "QLabel#aboutMutedText { color: #7eb8d4; }\n"
        "QTextEdit#aboutTextView { background-color: #102d40; color: #d7e4ef; border-color: #2a6a9a; }\n"
        "QPushButton#aboutToggleButton:checked { background-color: #193343; color: #78e3f2; border-color: #2a6a9a; }\n"
